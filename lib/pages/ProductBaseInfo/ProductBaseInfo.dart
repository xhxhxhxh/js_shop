...
class _ProductBaseInfoState extends State<ProductBaseInfo> with AutomaticKeepAliveClientMixin{
  Map content;
  List attr;
          ...
          children: [
            Container(
              ...
              child: Column(
                ...
                children: [
                  Text(item['cate'], style: TextStyle(
                ...
                child: Wrap(
                    ...
                    children: item['list'].asMap().keys.map<Widget>((index) {
                      ...
                      return InkWell(
                        ...
                        child: Chip(
                            backgroundColor: item['selectedIndex'] == index ? Color(0xFFfb191b) : Color(0xFFededed) ,
                              ...
                              child: Column(
                                ...
                                children: [
                                  Text(text, style: TextStyle(
                                      fontSize: 30.sp,
                                      color: item['selectedIndex'] == index ? Colors.white : Colors.black
                                  ))
                                ],
                              ),
                              width: 130.w,
                 ...
                 child: Stack(
                   children: [
                     Container(
                       ...
                       child: ListView(
                         children: this.selectItem(setBottomState),
                       ),
                     ),
                     Positioned(
                         bottom: 0,
        ...
        children: [
          ...
          Container(
            ...
            child: Text(content['title'],
                style: TextStyle(
                    color: Colors.black87, fontSize: 36.w)),
          ),
          Container(
